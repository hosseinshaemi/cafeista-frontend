...
return(
    <div style={{width:'325px' , height:'300px' , borderRadius:'5px'}}>
        <div className="Payment">
            ...
            {/* <input id="wallet" type="radio" name="payment" className="Payment-wallet" style={{marginLeft:'250px'}}/>
            <label htmlFor="wallet" style={{marginLeft:'130px' , fontSize:'13px' , fontFamily:'IRANSansXLight' , position:'absolute' , bottom:'295px'}}>کیف پول</label>

            <input id="online-payment" type="radio" name="payment" className="Payment-wallet" style={{marginLeft:'-10px' , marginRight:'20px'}}/>
            <label htmlFor="online-payment" style={{marginLeft:'-30px' , marginRight:'100px', fontSize:'13px' , fontFamily:'IRANSansXLight' , marginBottom:'40px' , position:'absolute' , bottom:'255px'}}>پرداخت آنلاین</label> 
             */}
