...
const Basket = () => {
  ...
  return (
    <div style={{display:'flex' , flexDirection:'column' , justifyContent:'center' , overflow:'scroll'}}>
      <div>
      ...
      <div > 
        {isFabVisiblepay && (
            ...
            <button onClick={handleModalpayOpen} style={{ position:'absolute' , bottom:0 ,justifyContent:'center' , right:'11%' , marginTop:'10%'}}>ادامه</button>
        )}
          <Modal
          className="new-comment-modal"
        ...
        >
          <Payment setorderlist={setorderlist} handlemodalpay={handlemodalpay}/>
        </Modal>
      </div>
    </div>
  );
