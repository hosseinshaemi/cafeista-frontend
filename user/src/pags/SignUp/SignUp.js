    ...
    return(
        ...
        <div className="signupform">
            ...
            <div className="input-signup">
                <Inputs type='text' placeholder='نام و نام خانوادگی' value={inputs.username || ""} onChange={handlechange} />
                <CiUser className="icon" />
            </div>
            <div className="input-signup">
                <Inputs type='email' placeholder='ایمیل' value={inputs.emailaddress || ""}  onChange={ (e) => {
                    handlechange(e) ; 
                    emailhandeler(e) ;
                }}/>
            ...
            <div className="input-signup">
                <Inputs type='number' placeholder='شماره تلفن' onChange={handlechange} value={inputs.phonenumber || ""}/>
                <CiPhone className="icon"/>
            </div>
            <div className="input-signup">
                <Inputs type='password' placeholder='رمز عبور'  value={inputs.password || ""} onChange={handlechange}/>
            ...
            <p className="enter">
              <Link to="/enterLogin" className="entertext">  ورود </Link>
            </p>
