...
const Home = () => {
  const [isOpen, setIsOpen] = useState(true);
    // const [tableReservationRequests, setTableReservationRequests] = useState([]);
    // const [ordersPendingConfirmation, setOrdersPendingConfirmation] = useState([]);
    ...
    //   try {
    //     const response1 = await fetch("/api/table-reservation-requests");
    //     const tableRequestsData = await response1.json();
    //     setTableReservationRequests(tableRequestsData);

    //     const response2 = await fetch("/api/orders-pending-confirmation");
    //     const pendingConfirmationData = await response2.json();
    //     setOrdersPendingConfirmation(pendingConfirmationData);

    //     const response3 = await fetch("/api/orders-confirmed");
    //     const confirmedData = await response3.json();
    //     setOrdersConfirmed(confirmedData);
    //   } catch (error) {
  ...
  const ordersPendingConfirmation = [
    "( مهدی مختاری )",
    "( مهسا بدیعی )",
    "( زهرا عابدی )",
  ];
