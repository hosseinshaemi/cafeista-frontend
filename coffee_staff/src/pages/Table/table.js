...
const Table = () => {
    ...
    // for (let i = 0; i < 5; i++) {
    //     popups.push(
    //         <PopupState variant="popover" popupId={`demo-popup-menu-${i}`}>
    //             {(popupState) => (
    //                 <React.Fragment>
    //                     <Button className="my-button" variant="contained" {...bindTrigger(popupState)} sx={{ backgroundColor: "#1FB62E", color: "#37251B", width: 100, marginTop: 5, marginLeft: 2, marginRight: 1 }}>
    //                         9-10
    //                     </Button>
    //                     <Menu {...bindMenu(popupState)} style={{ width: 100 }}>
    //                         <MenuItem onClick={popupState.close} style={{ fontFamily: "IRANSansXLight", color: "#37251B" }}>رزرو</MenuItem>
    //                         <MenuItem onClick={popupState.close} style={{ fontFamily: "IRANSansXLight", color: "#37251B" }}>آزاد</MenuItem>
    //                     </Menu>
    //                 </React.Fragment>
    //             )}
    //         </PopupState>
            ...
            <Typography id="modal-modal-description" sx={{ mt: 2 }}>
                <div>
                    ...
                    <PopupState variant="popover" popupId="demo-popup-menu">
                        {(popupState) => (
                            <React.Fragment>
                                <Button className="my-button" variant="contained" {...bindTrigger(popupState)} sx={{ backgroundColor: buttonColor, color: "#37251B", width: 100, marginTop: 5, marginLeft: 2, marginRight: 1 }}>
                                    8-9
                                </Button>
                                <Menu {...bindMenu(popupState)}>
                                    <MenuItem onClick={() => { setButtonColor("#FF0000"); popupState.close(); }} style={{ fontFamily: "IRANSansXLight", color: "#37251B" }}>رزرو</MenuItem>
                                    <MenuItem onClick={() => { setButtonColor("#1FB62E"); popupState.close(); }} style={{ fontFamily: "IRANSansXLight", color: "#37251B" }}>آزاد</MenuItem>
                                </Menu>
                            </React.Fragment>
                        )}
                    </PopupState>
                    ...
                    <PopupState variant="popover" popupId="demo-popup-menu">
                        {(popupState) => (
                            <React.Fragment>
                                <Button className="my-button" variant="contained" {...bindTrigger(popupState)} sx={{ backgroundColor: buttonColor1, color: "#37251B", width: 100, marginTop: 5, marginLeft: 2, marginRight: 1 }}>
                                    9-10
                                </Button>
                                <Menu {...bindMenu(popupState)}>
                                    <MenuItem onClick={() => { setButtonColor1("#FF0000"); popupState.close(); }} style={{ fontFamily: "IRANSansXLight", color: "#37251B" }}>رزرو</MenuItem>
                                    <MenuItem onClick={() => { setButtonColor1("#1FB62E"); popupState.close(); }} style={{ fontFamily: "IRANSansXLight", color: "#37251B" }}>آزاد</MenuItem>
                                </Menu>
                            </React.Fragment>
                        )}
                    </PopupState>
        ...
        <div>
            <div style={{ flex: "1 1", position: "fixed", height: "97vh", left: "0px", right: "185px", marginTop: "80px" }}>
                <div style={{ backgroundColor: "#F0E5D4", height: "85%", width: "98%", marginLeft: "30px", borderRadius: 10, overflow: "auto" }}>
                    <TextField label="شروع ساعت کاری" variant="filled" size="small" style={{ top: 15, width: 130, left: 135 }} />
                    <TextField label="پایان ساعت کاری" variant="filled" size="small" style={{ top: 15, right: 135, width: 130 }} />
