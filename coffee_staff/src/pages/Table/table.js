...
const Table = () => {
  ...
  for (let i = 0; i < difference; i++) {
    ...
    popups.push(<TimeButton timeValue={time} key={i} />);
  }
      ...
      >
        ...
        >
          <img
            ...
            src={isOpenDay ? openImg : closeImg}
            onClick={toggleImage}
            alt={isOpenDay ? "Close" : "Open"}
          />
          ...
          <div>
            ...
            <TextField
              ...
              variant="filled"
              size="small"
              style={{ top: 17, width: 120, marginRight: "1%" }}
